 ...
 */
public class studentCourse extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtstartTime.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(studentCourse.this, new TimePickerDialog.OnTimeSetListener() {
    ...
    public void createCourse(View view) {
        if (txtcourseId.getText().toString().trim().equals("")) {
            ...
            courses.setProfname(txtprofName.getText().toString().trim());
