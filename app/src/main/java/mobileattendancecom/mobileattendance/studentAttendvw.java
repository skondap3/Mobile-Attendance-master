...
/**
 * Created by riju on 7/5/16.
 */
public class studentAttendvw  extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attend_studvw);
        Intent myIntent = getIntent();
        scourse = myIntent.getStringExtra("courseid");
    ...
    protected void onStart() {
        super.onStart();
        arylistStudents=listData.markedAttendstvw(scourse);
